...
class Story_File_Status(models.Model):
    ...
    file_dir=models.CharField(max_length=200,default="/static/moment/story/1_eng")
...
class Wonder_Archive_People(models.Model):
    ...
    nick_name=models.CharField(max_length=50,default="Unknown Position")
    full_name = models.CharField(max_length=200,default="Unkown name")
    ...
    illustration=models.CharField(max_length=200,default="Mysterious creature. No intro valid.")
